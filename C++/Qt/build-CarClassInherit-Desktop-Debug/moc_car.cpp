...
const QMetaObjectExtraData Car::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Car::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Car,
      qt_meta_data_Car, &staticMetaObjectExtraData }
};
